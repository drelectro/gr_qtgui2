...
static const char qt_meta_stringdata_ConstellationDisplayPlot[] = {
    "ConstellationDisplayPlot\0\0s\0"
    "resizeSlot(QSize*)\0plotItem,on\0"
...
int ConstellationDisplayPlot::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: LegendEntryChecked((*reinterpret_cast< QwtPlotItem*(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 2;
    }
