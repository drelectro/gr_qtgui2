...
static const char qt_meta_stringdata_FrequencyDisplayPlot[] = {
    "FrequencyDisplayPlot\0\0e\0resizeSlot(QSize*)\0"
...
int FrequencyDisplayPlot::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: SetLowerIntensityLevel((*reinterpret_cast< const double(*)>(_a[1]))); break;
        case 2: SetUpperIntensityLevel((*reinterpret_cast< const double(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
